...
<head>
    ...
    <meta name="description" content="HoMS Appointment page">
    <meta name="author" content="Muhammad Syazwan">
  ...
  <symbol id="grid" viewBox="0 0 16 16">
    ...
    <div th:each="item : ${p}">
        ...
        <form  method="post" action="bookAppointment" onsubmit="alertUser()">
            ...
            <div class="ms">Medical Speciality</div>
            
              <input class="rectanglems" type="text" id="medicalSpecialityID" name="medicalSpeciality" placeholder="Insert your medical speciality here">
            
            <div class="treatmentinquiryfor">Treatment Inquiry for</div>

                <input class="firstoption" type="radio" id="myself" name="treatmentInquiry" value="Myself">
                <label class="myself" for="myself">Myself</label><br>
