    	...
    	<form method="post" action="">
        	...
        	<select class="form-control1" name="staff_name">
      		...
      		<h3 class="contact-text">Contact Number:</h3>
   			...
   			<h3 class="oc-timein-text">Time In:</h3> <input class="form-control3" type="time" name="time" value="12:00" ><br>
   
   			<h3 class="oc-timeout-text">Time Out:</h3> <input class="form-control4" type="time" name="time" value="12:00" ><br>

			<h3 class ="schedule-text">Today Schedule</h3>
			<h3 class = "sc-timein-text">Time In:</h3> <input class="form-control5" type="time" name="time" value="12:00" ><br>
			<h3 class="sc-timeout-text">Time Out:</h3> <input class="form-control6" type="time" name="time" value="12:00" ><br>
	
			<h3 class="notes-text">Notes</h3>
			<textarea class="form-control7" name="notes" placeholder="Write something here..." rows="4" cols="25"></textarea>
